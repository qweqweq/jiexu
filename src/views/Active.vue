  ...
  <div id="active">
    <background-img>
      <div class="normalHeader">
        <banner src="imgs/active/active_bg1.jpg" />
        <div class="nhCover" />
      </div>
    </background-img>
    <v-container class="lighten-5">
      ...
      >
        <v-flex
          ...
          :key="i"
          style="width: 30%; margin-right: 8px; margin-top: 5px; min-width: 200px;"
        >
          <v-card
            class="pa-2"
            outlined
          ...
          >
            ...
            <v-card-text style="color: #0d3084;font-size: 15px;font-weight: bold;">
              {{ item.header }}
            </v-card-text>
